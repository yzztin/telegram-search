...
import { handleDialogsEvent, registerDialogsEventHandler } from './event-handlers/dialogs'
import { handleEntityEvent, registerEntityEventHandler } from './event-handlers/entity'
import { handleMessageEvent, registerMessageEventHandler } from './event-handlers/messages'
